...
const ProgressPanel = ({ value = 700 }) => {
  return (
    <div className="flex-y panel-container pos-relative">
      <div className="an-24 bold-text light--text left-panel-text">
        POTENZA BRACCIO SX
      </div>
      ...
      >
        <div>
          <div className="top-border-white"></div>
          <div className="top-w-number an-24 regular-text">1200W</div>
        </div>
      </div>
      <div
      ...
      >
        <div>
          ...
          <div className="w-number an-24 regular-text">900W</div>
        </div>
      </div>
      <div
      ...
      >
        <div>
          <div className="border-white"></div>
          <div className="w-number an-24 regular-text">600W</div>
        </div>
      </div>
      <div
      ...
      >
        <div>
          <div className="border-white"></div>
          <div className="w-number an-24 regular-text">300W</div>
        </div>
      </div>
      <div
      ...
      >
        <div>
          <div className="border-white"></div>
          <div className="w-number an-24 regular-text">0W</div>
        </div>
      </div>
    </div>
  );
